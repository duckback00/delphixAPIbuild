...
$virtualNetworkName = 'alan_bitterman-vnet/default'  
  
#Resource group of the VM to be clonned from   
$resourceGroupName = 'alan_bitterman'  
  
#Region where managed disk will be created  
$location = 'eastus'  
  
#Names of source and target (new) VMs  
$sourceVirtualMachineName = 'win1'  
$targetVirtualMachineName = 'win2'  
  
#Name of snapshot which will be created from the Managed Disk  
$snapshotName = $sourceVirtualMachineName + '_snapshot1'  
...
#Select-AzureRmSubscription -SubscriptionId 'amb'  
