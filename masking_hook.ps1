#########################################################
## Simple Delphix Masking Hook  ... 

$hookFile=".\hook.ps1"         # Hook FileName
$HOOK=@'
...
#$results = (Invoke-RestMethod -Method POST -URI "$BaseURL/login" -body "{""username"": ""admin"", ""password"": ""Admin-12""}" -ContentType: 'application/json'  )
